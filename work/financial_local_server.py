...
:root{--ink:#172033;--muted:#66758a;--line:#d8dee8;--nav:#172232;--blue:#2d7d9a;--shadow:0 12px 28px rgba(20,30,45,.08)}*{box-sizing:border-box}body{margin:0;background:#eef2f5;color:var(--ink);font-family:-apple-system,BlinkMacSystemFont,"Segoe UI","Microsoft YaHei",sans-serif;line-height:1.5}.shell{display:grid;grid-template-columns:370px minmax(0,1fr);min-height:100vh}.side{background:var(--nav);color:#fff;padding:22px}.main{padding:22px;min-width:0}.brand h1{font-size:22px;margin:0 0 5px}.brand p,.note{font-size:13px;color:var(--muted)}.brand p{color:#c7d1df}.box{border:1px solid rgba(255,255,255,.18);background:rgba(255,255,255,.06);border-radius:9px;padding:14px;margin:14px 0}.field{margin-top:10px}.field label{display:block;font-size:13px;color:#dce6f1}.field input,.field textarea,.field select{width:100%;margin-top:5px;border:1px solid rgba(255,255,255,.24);background:#273444;color:#fff;border-radius:8px;padding:9px}.field textarea{min-height:70px}.drop{border:1px dashed rgba(255,255,255,.4);border-radius:8px;padding:14px;text-align:center}.native-file{width:100%;margin-top:10px}.file-name,.status{font-size:13px;color:#dce6f1;margin-top:9px;white-space:pre-wrap}.btn-row,.actions{display:flex;gap:8px;flex-wrap:wrap;margin-top:12px}button{border:0;border-radius:8px;padding:10px 14px;cursor:pointer}button.primary{background:var(--blue);color:#fff}button.ghost{background:transparent;color:#fff;border:1px solid rgba(255,255,255,.25)}button:disabled{opacity:.5}.progress{height:9px;background:rgba(255,255,255,.15);border-radius:99px;overflow:hidden;margin-top:10px}.progress span{display:block;height:100%;width:0;background:#69c294}.metrics,.cards{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}.metric,.panel,.card{background:#fff;border:1px solid var(--line);border-radius:9px;box-shadow:var(--shadow)}.metric,.card{padding:14px}.metric span,.card span{display:block;color:var(--muted);font-size:13px}.metric strong,.card strong{display:block;font-size:22px;margin-top:7px}.panel{padding:16px;margin-top:16px}.toolbar,.report-title{display:flex;align-items:center;justify-content:space-between;gap:12px}.toolbar h2{margin:0;font-size:18px}.actions{margin:0}.actions button{background:#edf3f7;color:#245d72}.empty,.model{padding:22px;background:#f4f7f9;border:1px dashed var(--line);border-radius:8px;color:var(--muted)}.model{margin:14px 0;color:#405065}.risk,.pill{display:inline-flex;border-radius:999px;padding:4px 10px;background:#fff3d6;color:#8a5b00}.pill.高{background:#fee4e2;color:#b42318}.pill.中{background:#fff3d6;color:#8a5b00}.pill.低{background:#e7f6ec;color:#247550}.table-wrap{overflow:auto}table{border-collapse:collapse;width:100%;min-width:820px;margin:10px 0 20px}th,td{border:1px solid #cfd7e3;padding:8px;text-align:left;font-size:13px;vertical-align:top}th{background:#f3f6f9}.debug{font-size:12px;color:var(--muted);white-space:pre-wrap}.note{margin-top:16px}@media(max-width:980px){.shell{grid-template-columns:1fr}.metrics,.cards{grid-template-columns:1fr 1fr}}@media(max-width:600px){.metrics,.cards{grid-template-columns:1fr}.side,.main{padding:14px}}@media print{.side,.actions,.debug{display:none}.shell{display:block}.main{padding:0}.panel,.metric,.card{box-shadow:none}}
