...
@media(max-width:980px){.shell{grid-template-columns:1fr}.metrics{grid-template-columns:1fr 1fr}.side{min-height:auto}}@media(max-width:620px){.metrics{grid-template-columns:1fr}.main{padding:14px}.side{padding:16px}}@media print{.side,.actions,.debug{display:none}.shell{display:block}.main{padding:0}.panel,.metric{box-shadow:none;border:0}.metrics{display:none}}
